...
// More modules (products, customers, suppliers, bills, inventory,
// reports, settings, users) are added incrementally per the
// project's milestone roadmap - see docs/ROADMAP.md
